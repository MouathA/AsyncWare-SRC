...
public class Block
{
    ...
    public void addCollisionBoxesToList(final World world, final BlockPos blockPos, final IBlockState blockState, final AxisAlignedBB axisAlignedBB, final List list, final Entity entity) {
        final EventCollide eventCollide = new EventCollide(entity, blockPos.getX(), blockPos.getY(), blockPos.getZ(), this.getCollisionBoundingBox(world, blockPos, blockState), this);
        eventCollide.call();
        final AxisAlignedBB boundingBox = eventCollide.getBoundingBox();
        final EventBoundingBox eventBoundingBox = new EventBoundingBox(boundingBox, blockState.getBlock(), blockPos.getX(), blockPos.getY(), blockPos.getZ());
        eventBoundingBox.call();
        if (eventBoundingBox.isCancelled()) {
            return;
        }
    ...
    public static void registerBlocks() {
        ...
        final Block setCreativeTab2 = new Block(Material.rock, MapColor.redColor).setHardness(2.0f).setResistance(10.0f).setStepSound(Block.soundTypePiston).setUnlocalizedName("brick").setCreativeTab(CreativeTabs.tabBlock);
        ...
        registerBlock(53, "oak_stairs", new BlockStairs(setUnlocalizedName.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK)).setUnlocalizedName("stairsWood"));
        ...
        registerBlock(99, "brown_mushroom_block", new BlockHugeMushroom(Material.wood, MapColor.dirtColor, setUnlocalizedName3).setHardness(0.2f).setStepSound(Block.soundTypeWood).setUnlocalizedName("mushroom"));
        registerBlock(100, "red_mushroom_block", new BlockHugeMushroom(Material.wood, MapColor.redColor, setUnlocalizedName4).setHardness(0.2f).setStepSound(Block.soundTypeWood).setUnlocalizedName("mushroom"));
        ...
        registerBlock(109, "stone_brick_stairs", new BlockStairs(setUnlocalizedName7.getDefaultState().withProperty(BlockStoneBrick.VARIANT, BlockStoneBrick.EnumType.DEFAULT)).setUnlocalizedName("stairsStoneBrickSmooth"));
        ...
        registerBlock(128, "sandstone_stairs", new BlockStairs(setUnlocalizedName2.getDefaultState().withProperty(BlockSandStone.TYPE, BlockSandStone.EnumType.SMOOTH)).setUnlocalizedName("stairsSandStone"));
        ...
        registerBlock(134, "spruce_stairs", new BlockStairs(setUnlocalizedName.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.SPRUCE)).setUnlocalizedName("stairsWoodSpruce"));
        registerBlock(135, "birch_stairs", new BlockStairs(setUnlocalizedName.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.BIRCH)).setUnlocalizedName("stairsWoodBirch"));
        registerBlock(136, "jungle_stairs", new BlockStairs(setUnlocalizedName.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.JUNGLE)).setUnlocalizedName("stairsWoodJungle"));
        ...
        registerBlock(156, "quartz_stairs", new BlockStairs(setUnlocalizedName9.getDefaultState().withProperty(BlockQuartz.VARIANT, BlockQuartz.EnumType.DEFAULT)).setUnlocalizedName("stairsQuartz"));
        ...
        registerBlock(163, "acacia_stairs", new BlockStairs(setUnlocalizedName.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.ACACIA)).setUnlocalizedName("stairsWoodAcacia"));
        registerBlock(164, "dark_oak_stairs", new BlockStairs(setUnlocalizedName.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.DARK_OAK)).setUnlocalizedName("stairsWoodDarkOak"));
    ...
    public float getPlayerRelativeBlockHardness(final EntityPlayer entityPlayer, final World world, final BlockPos blockPos) {
        ...
        return (blockHardness < 0.0f) ? 0.0f : (entityPlayer.canHarvestBlock(this) ? (entityPlayer.getToolDigEfficiency(this) / blockHardness / 30.0f) : (entityPlayer.getToolDigEfficiency(this) / blockHardness / 100.0f));
    }
    ...
    public boolean shouldSideBeRendered(final IBlockAccess blockAccess, final BlockPos blockPos, final EnumFacing enumFacing) {
        final Xray xray = new Xray();
        if (Asyncware.instance.moduleManager.getModuleByName("Xray").isToggled()) {
            return xray.isCapable(blockPos.getBlock());
        }
    ...
    public static int getStateId(final IBlockState blockState) {
        ...
        return getIdFromBlock(block) + (block.getMetaFromState(blockState) << 12);
    }
