...
public class AchievementList
{
    ...
    static {
        ...
        AchievementList.exploreAllBiomes = new Achievement("achievement.exploreAllBiomes", "exploreAllBiomes", 4, 8, Items.diamond_boots, AchievementList.theEnd).func_150953_b((Class)JsonSerializableSet.class).setSpecial().registerStat();
