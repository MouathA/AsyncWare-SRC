...
public class InventoryPlayer implements IInventory
{
    ...
    public void dropAllItems() {
        ...
        while (0 < this.mainInventory.length) {
            if (this.mainInventory[0] != null) {
                this.player.dropItem(this.mainInventory[0], true, false);
        ...
        while (0 < this.armorInventory.length) {
            if (this.armorInventory[0] != null) {
                this.player.dropItem(this.armorInventory[0], true, false);
    ...
    public int clearMatchingItems(final Item item, final int n, final int n2, final NBTTagCompound nbtTagCompound) {
        ...
        while (0 < this.mainInventory.length) {
            ...
            if (itemStack != null && (item == null || itemStack.getItem() == item) && (n <= -1 || itemStack.getMetadata() == n) && (nbtTagCompound == null || NBTUtil.func_181123_a((NBTBase)nbtTagCompound, (NBTBase)itemStack.getTagCompound(), true))) {
        ...
        while (0 < this.armorInventory.length) {
            ...
            if (itemStack3 != null && (item == null || itemStack3.getItem() == item) && (n <= -1 || itemStack3.getMetadata() == n) && (nbtTagCompound == null || NBTUtil.func_181123_a((NBTBase)nbtTagCompound, (NBTBase)itemStack3.getTagCompound(), false))) {
        ...
        if (this.itemStack != null) {
            ...
            if (nbtTagCompound != null && !NBTUtil.func_181123_a((NBTBase)nbtTagCompound, (NBTBase)this.itemStack.getTagCompound(), false)) {
                return 0;
            }
