...
public class NettyEncryptionTranslator
{
    ...
    private byte[] func_150502_a(final ByteBuf byteBuf) {
        ...
        byteBuf.readBytes((byte[])this.field_150505_b, 0, readableBytes);
    ...
    protected void cipher(final ByteBuf byteBuf, final ByteBuf byteBuf2) throws ShortBufferException {
        ...
        byteBuf2.writeBytes((byte[])this.field_150506_c, 0, this.cipher.update(func_150502_a, 0, readableBytes, this.field_150506_c));
    }
}
