...
public class ModelWither extends ModelBase
{
    ...
    public void setLivingAnimations(final EntityLivingBase entityLivingBase, final float n, final float n2, final float n3) {
        ...
        while (true) {
            this.field_82904_b[1].rotateAngleY = (entityWither.func_82207_a(0) - entityLivingBase.renderYawOffset) / 57.295776f;
            this.field_82904_b[1].rotateAngleX = entityWither.func_82210_r(0) / 57.295776f;
            int n4 = 0;
            ++n4;
        }
    }
