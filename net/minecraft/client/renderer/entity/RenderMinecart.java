...
public class RenderMinecart extends Render
{
    ...
    public void doRender(final EntityMinecart entityMinecart, double n, double n2, double n3, float n4, final float n5) {
        ...
        final IBlockState displayTile = entityMinecart.getDisplayTile();
        if (displayTile.getBlock().getRenderType() != -1) {
            ...
            this.func_180560_a(entityMinecart, n5, displayTile);
    ...
    protected void func_180560_a(final EntityMinecart entityMinecart, final float n, final IBlockState blockState) {
        Minecraft.getMinecraft().getBlockRendererDispatcher().renderBlockBrightness(blockState, entityMinecart.getBrightness(n));
    }
