...
public class GuiSpectator extends Gui implements ISpectatorMenuRecipient
{
    ...
    protected void func_175258_a(final ScaledResolution scaledResolution, final float n, final int n2, final float n3, final SpectatorDetails spectatorDetails) {
        ...
        this.drawTexturedModalRect((float)(n2 - 91), n3, 0, 0, 182, 22);
        if (spectatorDetails.func_178681_b() >= 0) {
            this.drawTexturedModalRect((float)(n2 - 91 - 1 + spectatorDetails.func_178681_b() * 20), n3 - 1.0f, 0, 22, 24, 22);
        }
        while (true) {
    ...
    private void func_175266_a(final int n, final int n2, final float n3, final float n4, final ISpectatorMenuObject spectatorMenuObject) {
        ...
        if (spectatorMenuObject != SpectatorMenu.field_178657_a) {
            ...
            if (n5 > 3 && spectatorMenuObject.func_178662_A_()) {
                this.field_175268_g.fontRendererObj.drawStringWithShadow(value, (float)(n2 + 19 - 2 - this.field_175268_g.fontRendererObj.getStringWidth(value)), n3 + 6.0f + 3.0f, 16777215 + (n5 << 24));
            }
        }
    }
    ...
    public void func_175263_a(final ScaledResolution scaledResolution) {
        ...
        if (n > 3 && this.field_175271_i != null) {
            ...
            final String s = (func_178645_b != SpectatorMenu.field_178657_a) ? func_178645_b.getSpectatorName().getFormattedText() : this.field_175271_i.func_178650_c().func_178670_b().getFormattedText();
            if (s != null) {
                final int n2 = (scaledResolution.getScaledWidth() - this.field_175268_g.fontRendererObj.getStringWidth(s)) / 2;
                final int n3 = scaledResolution.getScaledHeight() - 35;
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                this.field_175268_g.fontRendererObj.drawStringWithShadow(s, (float)n2, (float)n3, 16777215 + (n << 24));
            }
        }
    }
