...
public class GuiAchievements extends GuiScreen implements IProgressMeter
{
    ...
    protected void drawAchievementScreen(final int n, final int n2, final float n3) {
        ...
        while (0 * n14 - n13 < 155.0f) {
            ...
            while (0 * n15 - n12 < 224.0f) {
                random.setSeed(this.mc.getSession().getPlayerID().hashCode() + n10 + 0 + (n11 + 0) * 16);
                ...
                this.drawTexturedModalRect(0 - n12, 0 - n13, textureAtlasSprite, 16, 16);
                int n18 = 0;
                ++n18;
            }
            ++n19;
        ...
        while (0 < AchievementList.achievementList.size()) {
            ...
            Label_1295: {
                if (n24 >= -24 && n25 >= -24 && n24 <= 224.0f * this.field_146570_r && n25 <= 155.0f * this.field_146570_r) {
                    ...
                    this.itemRender.renderItemAndEffectIntoGUI(achievement3.theItemStack, n24 + 3, n25 + 3);
        ...
        if (achievement2 != null) {
            ...
            if (this.statFileWriter.canUnlockAchievement(achievement2)) {
                ...
                this.drawGradientRect(n32 - 3, n33 - 3, n32 + max + 3, n33 + 3 + 12, -1073741824, -1073741824);
                this.fontRendererObj.drawSplitString(description, n32, n33 + 12, max, -6250336);
                if (this.statFileWriter.hasAchievementUnlocked(achievement2)) {
                    this.fontRendererObj.drawStringWithShadow(I18n.format("achievement.taken", new Object[0]), (float)n32, (float)(n33 + 4), -7302913);
                }
            }
            ...
            if (s != null) {
                this.fontRendererObj.drawStringWithShadow(s, (float)n32, (float)n33, this.statFileWriter.canUnlockAchievement(achievement2) ? (achievement2.getSpecial() ? -128 : -1) : (achievement2.getSpecial() ? -8355776 : -8355712));
            }
        }
    }
    ...
    public void drawScreen(final int field_146563_h, final int field_146564_i, final float n) {
        if (this.loadingAchievements) {
            ...
            this.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.downloadingStats", new Object[0]), GuiAchievements.width / 2, GuiAchievements.height / 2, 16777215);
            this.drawCenteredString(this.fontRendererObj, GuiAchievements.lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % GuiAchievements.lanSearchStates.length)], GuiAchievements.width / 2, GuiAchievements.height / 2 + this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
        }
        else {
